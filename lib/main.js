    ...
    var api = {
        file: {
            ...
            fromUrl: function(fileUrl, options, callback) {
                ...
                //filename
                post('/from_url/', mergeObjects(options, {
                    data: form,
                    form: true
                }), function(err, res) {
                    if(err){
        ...
        files: {
            ...
            storeCustom: function(fileId, target, callback) {
                post('/files/', mergeObjects(globalOptions, { data: { source: fileId, target: target } }), callback);
            },
            ...
            removeMultiple: function(fileIds, callback) {
                _request('DELETE', '/files/storage/', mergeObjects(globalOptions, { data: fileIds }), callback);
            },
        ...
        group: {
            fromFiles: function(files, options, callback) {
                ...
                post('/group/', mergeObjects(options, {
                    data:   form,
                    ssl:    true,
                    form:   true
                }), callback);
        ...
        groups: {
            ...
            store: function(groupId, callback) {
                put('/groups/' + groupId + '/storage/', globalOptions, callback);
            },
            remove: function(groupId, callback) {
                this.info(groupId, function(err, info) {
                    ...
                    _request('DELETE', '/files/storage/', mergeObjects(globalOptions, { data: fileIds }), function(err, res) {
